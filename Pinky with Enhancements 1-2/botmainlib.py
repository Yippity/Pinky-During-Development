...
from cmd_master_list import \
    ALL_COMMANDS  # ALL_COMMANDS is a dictionary that holds information regarding each of Pinky's commands
        ...
        for x in range(len(
            ...
            if (str(emojis[x]) == str(reaction.emoji)):
                ...
                role = server.get_role(
                    messagedata[0][x]
                )  # Fetches role object based on role ID listed in first list
